...
let projects = [
  {
    image: 'textures/dapp-project.png',
    url: 'https://dapp.lott.link',
  },
  {
    image: 'textures/lott-link-project.png',
    url: 'https://lott.link',
  },
  {
    image: 'textures/fakhar-project.png',
    url: 'https://fakharseller.com',
  },
  {
    image: 'textures/fx-explorer-project.png',
    url: 'https://fx-explorer.com',
  },
  {
    image: 'textures/peikava-project.png',
    url: 'https://www.peikava.ir',
  },
];
let aboutCameraPos = {
  x: 0.12,
    ...
    room.scene.children.forEach((child) => {
      ...
      if (child.name === 'Book') {
        ...
        const bookTexture = new THREE.TextureLoader().load(
          'textures/MohammadAminAhmadi_resume.jpg'
        );
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Amin Ahmadi', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
